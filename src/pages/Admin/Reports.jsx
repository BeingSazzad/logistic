      ...
      <div className="flex justify-between items-center mb-2 px-2">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Annual income performance and Depot contribution tracking.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col">
          <div className="p-5 border-b border-gray-100 flex items-center gap-3 bg-[#FAFAFA]">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">{selectedYear} Performance</p>
            </div>
          </div>

          <div className="flex flex-col divide-y divide-gray-50">
            {branchPerformance.map((Depot, i) => (
              <div key={i} className="p-5 group hover:bg-gray-50/50 transition-colors cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-gray-400">{Depot.efficiency}%</span>
                </div>
              </div>
            ))}
          </div>
