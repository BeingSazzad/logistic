...
export default function AdminLoadDetail() {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto pb-16">
      <button onClick={() => navigate('/admin/loads')}
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-3">
          ...
          >
            <Printer size={16}/> Generate Label
          </button>
          <button
             ...
             <div className="space-y-6 relative z-10">
                ...
                <div className="flex flex-col gap-3">
                   <div className="flex bg-white/5 p-1 rounded-xl border border-white/10 mb-1">
                     {[{key:'Depot', label:'Depot to Depot'},{key:'door', label:'Door to Door'}].map(m => (
                       <button
                         key={m.key}
                    ...
                    <div className="space-y-5">
                       ...
                       <div className="space-y-1.5">
                         ...
                         <div className="w-full h-24 bg-blue-50/50 border-2 border-dashed border-blue-200 hover:border-blue-400 rounded-xl flex flex-col items-center justify-center text-blue-500 transition-colors cursor-pointer group">
                             ...
                             <span className="text-xs font-bold uppercase tracking-widest">Upload Signed Document</span>
                         </div>
                       </div>
      ...
      {showLabelModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            {/* Label Preview */}
            <div className="p-6" id="label-print-area">
              <div className="border-2 border-gray-900 rounded-xl p-5 font-mono space-y-3">
                ...
                {/* Barcode placeholder */}
                <div className="border-t border-dashed border-gray-300 pt-3">
                  <div className="flex gap-px justify-center h-12 items-end">
            ...
            <div className="flex gap-3 px-6 pb-6">
              <button onClick={() => setShowLabelModal(false)} className="btn btn-outline flex-1 text-sm">Cancel</button>
              <button onClick={() => window.print()} className="btn btn-primary flex-1 text-sm">
