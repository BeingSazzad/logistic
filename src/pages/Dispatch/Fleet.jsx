                 ...
                 <tr className="hover:bg-gray-50/50 transition-all cursor-pointer group" key={v.id} onClick={() => navigate(`/dispatch/vehicles/${v.id}`)}>
                   <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-gray-400 font-black tracking-widest uppercase mt-0.5">{v.reg}</div>
                        </div>
                      </div>
                   </td>
                   <td className="px-6 py-5 whitespace-nowrap">
                      <div className="text-sm font-bold text-gray-700">{v.type}</div>
                      <div className="text-[10px] text-gray-400 font-bold uppercase">{v.cap} Payload</div>
                   </td>
                   <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        <span className={`text-[9px] font-black px-2 py-1 rounded shadow-sm border uppercase tracking-widest ${
                   ...
                   <td className="px-6 py-5 text-right">
                    ...
                    <td className="px-6 py-4 text-right">
                       <button className="text-[10px] font-black text-blue-600 hover:text-white border border-blue-200 hover:bg-blue-600 hover:border-blue-600 px-4 py-2 rounded-lg transition-all uppercase tracking-widest shadow-sm">
                         View Details
                       </button>
                    </td>
                 </tr>
