            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
               <div className="grid grid-cols-2 gap-3">
                  <div className="bg-white/5 backdrop-blur-md p-4 rounded-hero-md border border-white/10 shadow-inner">
                     ...
                     <span className="text-2xl font-semibold text-brand">03</span>
                  </div>
                  <div className="bg-white/5 backdrop-blur-md p-4 rounded-hero-md border border-white/10 shadow-inner">
                     <span className="hero-metadata text-gray-500 block mb-1">Monthly Volume</span>
                     <span className="text-2xl font-semibold text-white">412</span>
                  </div>
               </div>
               <button onClick={() => navigate('/customer/tracking')} className="btn bg-brand hover:bg-brand-hover text-hero-dark py-4 px-8 rounded-hero-md font-semibold shadow-lg shadow-brand/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="lg:col-span-2 space-y-5">
            <div className="flex justify-between items-end px-2">
               ...
               <button className="text-xs font-semibold text-yellow-600 uppercase tracking-widest hover:underline flex items-center gap-1">Full Tracking View <ArrowRight size={14}/></button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div key={s.id} onClick={() => navigate('/customer/tracking')} className={`bg-white rounded-[2rem] border p-6 flex flex-col gap-6 hover:shadow-2xl transition-all cursor-pointer group active:scale-[0.98] ${s.alert ? 'border-red-100 bg-red-50/10' : 'border-gray-50'}`}>
                     <div className="flex justify-between items-start">
                        <div className="flex items-center gap-3">
                           ...
                           <div>
                              <p className="font-semibold text-gray-900 text-sm tracking-tight">{s.id}</p>
               ...
               <div className="bg-gray-50 border border-dashed border-gray-200 rounded-[2rem] p-6 flex flex-col items-center justify-center text-center gap-4 hover:bg-gray-100 transition-colors cursor-pointer group">
                  ...
                  <div>
                     <p className="text-sm font-semibold text-gray-900 uppercase tracking-tight">Need another load?</p>
         ...
         <div className="space-y-8">
            ...
            <div className="bg-white rounded-[2.5rem] border border-red-100 p-8 shadow-xl shadow-red-500/5 flex flex-col gap-6 relative overflow-hidden">
               ...
               <div>
                  <h3 className="text-xs font-semibold text-red-500 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                     <Wallet size={14}/> Outstanding Balance
                  </h3>
                  <p className="text-4xl font-semibold text-gray-900 tracking-tighter">$4,887.50</p>
                  <p className="text-xs font-bold text-gray-400 mt-2 uppercase tracking-widest">Across 3 Unpaid Invoices</p>
               </div>
               <button onClick={() => navigate('/customer/invoices')} className="w-full bg-[#111] hover:bg-black text-white py-4 rounded-2xl font-semibold uppercase text-xs tracking-widest transition-all active:scale-95 flex items-center justify-center gap-3">
            ...
            <div className="bg-gray-50 rounded-[2.5rem] p-8 border border-gray-100">
               <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-[0.2em] mb-6">Concierge Support</h3>
               <div className="space-y-4">
                  <div className="flex items-center gap-4 bg-white p-4 rounded-3xl shadow-sm border border-gray-100">
                     ...
                     <div>
                        <p className="text-xs font-semibold text-gray-900 uppercase">Live Assistance</p>
                        <p className="text-xs font-bold text-gray-400 uppercase">Average response: 2m</p>
                     </div>
                  </div>
                  <button className="w-full py-3.5 text-xs font-semibold text-gray-900 uppercase tracking-widest border-2 border-gray-200 rounded-2xl hover:bg-white transition-all">Open Helpline</button>
               </div>
            </div>
